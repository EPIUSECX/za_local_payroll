    ...
    refresh: function(frm) {
        ...
        if (frm.doc.docstatus === 0) {
            frm.add_custom_button(__('Generate Certificate Data'), function() {
                if (frm.doc.generation_mode === 'Bulk') {
                    ...
                    frappe.call({
                        method: 'za_local_payroll.sa_payroll.doctype.irp5_certificate.irp5_certificate.bulk_generate_certificates',
        ...
        if (frm.doc.status && frm.doc.status !== "Draft" && frm.doc.docstatus !== 2) {
            frm.add_custom_button(__('Download IRP5 Certificate PDF'), function() {
                frappe.call({
                    method: 'za_local_payroll.sa_payroll.doctype.irp5_certificate.irp5_certificate.get_official_pdf',
